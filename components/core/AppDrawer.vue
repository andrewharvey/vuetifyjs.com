  ...
  v-navigation-drawer(
    ...
    div.text-xs-center
      ...
      div(
        ...
        a(
          ...
          img.diamond-sponsor(
            :src="`https://s3.amazonaws.com/vuetify-docs/static/doc-images/${diamond.src}`"
            :alt="diamond.title"
          )
      v-btn(
        small
    ...
    div.py-3.text-xs-center
      a(
        ...
        img(
          src="https://s3.amazonaws.com/vuetify-docs/static/doc-images/affiliates/vuejobs-logo.svg"
          alt="VueJobs"
          title="VueJobs"
          width="30%"
        )
