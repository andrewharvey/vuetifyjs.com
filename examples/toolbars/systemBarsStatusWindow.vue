<template>
  <div>
    ...
    <v-card img="https://s3.amazonaws.com/vuetify-docs/static/vuetify_layout1.svg" height="200px">
    ...
    <v-card img="https://s3.amazonaws.com/vuetify-docs/static/vuetify_layout2.svg" height="200px">
